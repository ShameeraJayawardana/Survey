                    ...
                    xmlhttp.onreadystatechange = function () {
                        if (this.readyState == 4 && this.status == 200) {
                            ...
                            for (var i = 0; i < res.length; i++) {
                                ...
                                opt.innerHTML = res[i][3];
                                sel.appendChild(opt);
                            }
                        }
                    };
                    xmlhttp.open("GET", "searchBackend.php?q=" + str, true);
                    xmlhttp.send();
                }
            }
        </script>
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper" id="background">
            ...
            <div class="row" id="content">
                <div class="col-md-12" style="display: flex; justify-content: center; align-items: flex-end; height: 50%;">
                    <h1 id="title">SEARCH FOR DOCUMENTS</h1>
                </div>
                <div class="col-md-12" style="display: flex; justify-content: center; align-items: flex-start; height: 50%;">
                    <input type="text" name="search" placeholder="Search.." id="search" oninput="searchDoc(this.value)" on>
                </div>
            </div>
