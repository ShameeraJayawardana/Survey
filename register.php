        ...
        <div class="card-body">
            <form method="post" action="register.php">
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-md-12">
                            ...
                            <input class="form-control" required name="name" id="exampleInputName" type="text"
                                   aria-describedby="nameHelp" placeholder="Enter Your Name with Initials">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-md-12">
                            ...
                            <input class="form-control" required name="emplNo" id="emplNo" type="text"
                                   aria-describedby="emplHelp" placeholder="Enter your Employee Number">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" required name="email" id="exampleInputEmail1" type="email"
                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" required name="password" id="exampleInputPassword1"
                                   type="password" placeholder="Password">
                        </div>
                        <div class="col-md-6">
                            <label for="exampleConfirmPassword">Confirm password</label>
                            <input class="form-control" required name="confirm" id="exampleConfirmPassword"
