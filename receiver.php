...
if (isset($_POST['submit'])) {
    ...
    $sender = $_POST['sender'];
    $s = "SELECT * FROM member WHERE name = '$sender'";
    $s_set = mysqli_query($conn, $s);
    $s_arr = mysqli_fetch_assoc($s_set);

    foreach ($_POST['return'] as $value) {
        $insert = "INSERT INTO receiv(receiv_no,sender,receiver,doc_id,datetime) VALUES('$receive_no', '$_POST[sender]', '$receiver', '$value','$date')";
