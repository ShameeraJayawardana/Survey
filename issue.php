...
if (isset($_POST['submit'])) {
    ...
    $insert = "INSERT INTO issue(issue_no,issuer,receiver,doc_id,datetime,status) VALUES('$issue_no', '$issuer', '$_POST[receiver]', '$_POST[doc_id]','$date', '$status')";
                ...
                <div class="col-md-8">
                    ...
                    <form action="issue.php" method="post">
                        <div class="form-group">
                            <input type="hidden" name="myNo" class="form-control" placeholder="My Number" value="<?php echo $issue_no; ?>" /><br>
                            <label>Issued to(name)</label>&nbsp;&nbsp;
                            <select class="alert" name="receiver">
